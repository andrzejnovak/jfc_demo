...
> **Demo seed note.** If this analysis was scaffolded with a demo seed
> (`.analysis_config` contains `demo_seed=`), this phase's artifact is
> pre-provided — the orchestrator validates-and-adopts it (see root
> CLAUDE.md "Fast Demo Mode") rather than running this phase live.
